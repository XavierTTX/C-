...
float directioTo1(float x1, float y1, float x2, float y2);

float directioTo1(float x1, float y1, float x2, float y2) {
	return atan2((y2 - y1), (x2 - x1));
}

BigShotTower::BigShotTower(float x, float y, float h, float w)
{
...
BigShotTower::~BigShotTower()
{
	delete _box;
}

void BigShotTower::draw()
{
	double d = (0);
...
void BigShotTower::act()
{
	...
	if (-1 != minI) {
		...
		if (b != nullptr) {
			this->_dir = directioTo1(this->_box->getfloatX(), this->_box->getfloatY(), b->getBox()->getfloatX(), b->getBox()->getfloatY());
			if (!this->nextshot % (120 - 5 * _levelS)) {
				GameBoard::instance->addShot(new CheapShot(this->_box->getfloatX(), this->_box->getfloatY(), this->_box->getfloatHeight() *0.3f, this->_box->getfloatWidth()*0.3, this->_dir , 15 + _levelD * 7));
			/*	GameBoard::instance->addShot(new CheapShot(this->_box->getfloatX(), this->_box->getfloatY(), this->_box->getfloatHeight() *0.1f, this->_box->getfloatWidth()*0.1, this->_dir - PI / 3, 3 + _levelD * 3));
				GameBoard::instance->addShot(new CheapShot(this->_box->getfloatX(), this->_box->getfloatY(), this->_box->getfloatHeight() *0.1f, this->_box->getfloatWidth()*0.1, this->_dir + PI / 3, 3 + _levelD * 3));
				GameBoard::instance->addShot(new CheapShot(this->_box->getfloatX(), this->_box->getfloatY(), this->_box->getfloatHeight() *0.1f, this->_box->getfloatWidth()*0.1, this->_dir , 3 + _levelD * 3));
*/
