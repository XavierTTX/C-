...
#define RED_OUTLINE 225.0f / 255.0f
#define BLUE_OUTLINE 225.0f / 255.0f 
#define GREEN_OUTLINE 255.0f / 255.0f 
...
SelectedTowerCreationUIDrawMethod::SelectedTowerCreationUIDrawMethod(const char * text, const char* price)
{
...
SelectedTowerCreationUIDrawMethod::~SelectedTowerCreationUIDrawMethod()
{
}

void SelectedTowerCreationUIDrawMethod::draw(float x, float y, float height, float width)
{
